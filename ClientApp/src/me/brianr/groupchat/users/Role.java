...
/**
 * An enum to define all of the roles.
 * @author Brian Reich
 * @version 1.0
 * @since 1.0
 */
public enum Role {
	...
	DEFAULT("#000000"), // For newly registered users and unregistered users.  Allows access to the most simple commands, if there even are any.
